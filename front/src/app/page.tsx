      ...
      {info && (
        <div className="w-full max-w-xl bg-white shadow-lg rounded-xl p-6 border border-gray-200">
          ...
          <dl className="space-y-3 text-sm">
            ...
            <div>
              <dt className="font-semibold text-gray-600">CN (Common Name):</dt>
              <dd>{info.subject.CN || '—'}</dd>
            </div>

            <div>
              <dt className="font-semibold text-gray-600">O (Organización):</dt>
              <dd>{info.subject.O || '—'}</dd>
            </div>

            <div>
              <dt className="font-semibold text-gray-600">OU (Unidad Organizativa):</dt>
